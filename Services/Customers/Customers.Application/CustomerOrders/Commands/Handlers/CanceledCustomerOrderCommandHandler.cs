...
public class CanceledCustomerOrderCommandHandler : CustomerOrderCommandHandler<CanceledCustomerOrderCommand, CustomerOrder>
{
    public CanceledCustomerOrderCommandHandler(ICustomerOrderDomainService domainService) : base(domainService)
    {
    }

    public override async Task<CustomerOrder> Handle(CanceledCustomerOrderCommand request, CancellationToken cancellationToken)
    {
